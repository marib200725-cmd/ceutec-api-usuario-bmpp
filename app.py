...
CORS(app, resources={
    r"/*": {
        "origins": ["http://localhost:5500","http://127.0.0.1:5500","https://frontend-ceutec-usuarios-bmpp.netlify.app"],
...
app.config['MYSQL_PASSWORD'] = 'qISRxObYEyuDjanmfzPmBSNXuwKwHsPZ'
